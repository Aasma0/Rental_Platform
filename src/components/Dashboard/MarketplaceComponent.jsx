...
const Marketplace = () => {
  ...
  const PropertyModal = ({ property, onClose }) => {
    ...
    const navigateImage = (direction) => {
      ...
      let newIndex;
      if (direction === 'prev') {
        newIndex = (currentImageIndex - 1 + property.images.length) % property.images.length;
      } else {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {properties.length === 0 && !loading && (
            <div className="text-center py-12">
              <p className="text-gray-600 text-lg">No properties currently available for sale</p>
            </div>
          )}
        </div>
      </div>
