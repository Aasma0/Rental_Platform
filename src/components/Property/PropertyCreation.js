            ...
            <div className="p-6 md:p-8">
              ...
              >
                ...
                <div>
                  ...
                  <select
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition appearance-none bg-white bg-no-repeat bg-[right_1rem_center] bg-[length:1.5em]"
                    value={category}
